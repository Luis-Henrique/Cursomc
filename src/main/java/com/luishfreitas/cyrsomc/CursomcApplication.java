...
import com.luishfreitas.cyrsomc.repositories.ItemPedidoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		p1.getProdutos().addAll(Arrays.asList(ip1));
		p2.getProdutos().addAll(Arrays.asList(ip3));
		p3.getProdutos().addAll(Arrays.asList(ip2));
